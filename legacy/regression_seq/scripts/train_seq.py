...
def main() -> None:
    ...
    search_space = [{'model_kind': 'gru', 'lookback': 48, 'hidden_dim': 32, 'dropout': 0.0}, {'model_kind': 'gru', 'lookback': 168, 'hidden_dim': 32, 'dropout': 0.0}, {'model_kind': 'lstm', 'lookback': 48, 'hidden_dim': 32, 'dropout': 0.0}, {'model_kind': 'lstm', 'lookback': 168, 'hidden_dim': 32, 'dropout': 0.0}]
